...
@Description(
        ...
        value = "_FUNC_(array rankItems, array correctItems [, const int recommendSize = rankItems.size])"
                + " - Returns ARHR")
public final class ARHRUDAF extends AbstractGenericUDAFResolver {
    ...
    public static class Evaluator extends GenericUDAFEvaluator {
        ...
        @Override
        public ARHRAggregationBuffer getNewAggregationBuffer() throws HiveException {
            ARHRAggregationBuffer myAggr = new ARHRAggregationBuffer();
            reset(myAggr);
            return myAggr;
        }
        ...
        public void reset(@SuppressWarnings("deprecation") AggregationBuffer agg)
            ...
            ARHRAggregationBuffer myAggr = (ARHRAggregationBuffer) agg;
            myAggr.reset();
        }
    ...
    public static class ARHRAggregationBuffer extends
            GenericUDAFEvaluator.AbstractAggregationBuffer {

        double sum;
        long count;

        public ARHRAggregationBuffer() {
            super();
        }
        ...
        void iterate(@Nonnull List<?> recommendList, @Nonnull List<?> truthList,
            ...
            sum += GradedResponsesMeasures.RHR(recommendList, truthList, recommendSize);
            count++;
        }
    }
}
