...
public class BigGIS {
    ...
    public static GISModel trainModel(int iterations, BigDataIndexer indexer, MatrixForTraining matrix, boolean printMessagesWhileTraining, boolean smoothing, Prior modelPrior, int cutoff) {
